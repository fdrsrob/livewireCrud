                                ...
                                <div class="row">
                                    <div class="col-md-11">
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control" wire:model="searchQuery" placeholder="Buscar por nombre, email, teléfono o carrera">
                                            <div class="input-group-append">
                                                <button class="btn btn-primary" type="button" wire:click="search">
                                                    <i class="bi bi-search"></i> Buscar
                                                </button>
                                                <button class="btn btn-secondary ml-2" onclick="window.location='{{ route('wolf.index') }}'">Ir a Carreras</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
